...
def update_leds(led, state):
    ...
    f = open("leds.txt", 'w')
    print(str(arregloBase[0]) + ',' + str(arregloBase[1]))
...
def main(api_endpoint, credentials, project_id,
    ...
    def play(song):
        logging.info('playing %s' % song)
        webbrowser.open(youtube2.youtube(song))
        


#    room = LED(8)

#    @device_handler.command('com.example.commands.RoomOn')
#    def roomOn(activate):
#        logging.info('Led turn on')
#        room.on()
